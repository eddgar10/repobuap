                ...
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <div class="box box-primary"><!-- general form elements -->
                        ...
                        <form action="action/editnamefolder.php" method="post" role="form"><!-- form start -->
                            <div class="box-body">
                                <div class="form-group">
                                    <label>Nombre Nuevo de la Carpeta</label>
                                        <textarea name="foldername" class="form-control" rows="1"></textarea>
                                </div>
                                <div class="form-group">
                                    <div class="checkbox icheck">
                                        <label>
                                            <input type="checkbox" name="is_public" checked <?php if($is_public){ echo "checked"; }?>> &nbsp;Archivo Publico
                                        </label>                                    </div>
                                </div>
                            </div><!-- /.box-body -->
                            <div class="box-footer">
